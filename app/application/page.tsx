    ...
    <div className="min-h-screen bg-[#046147] flex flex-col items-center justify-center px-6 py-12">
      ...
      <Link href="/">
        <Image
          ...
          width={300}
          height={100}
          className="h-24 md:h-32 w-auto mb-8 hover:opacity-80 transition-opacity"
        />
      </Link>
      ...
      <div className="flex items-center gap-8">
        <Link
          ...
          target="_blank"
          className="text-[#f6f3ed] hover:text-[#f2cce5] transition-colors flex items-center gap-2 text-lg"
        >
