  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto 0 flex flex-col md:flex-row justify-between items-center w-full">
        ...
        <div>
          <AnimatedTestimonials testimonials={testimonialsCarrousel} autoplay={true}/>
        </div>
      </div>
    </div>
  );
            ...
            >
              <AnimatePresence>
                {hoveredIndex === idx && (
                  ...
                  >
                    <div className="absolute inset-x-0 z-30 w-[20%] mx-auto -bottom-px bg-gradient-to-r from-transparent via-orange-600 to-transparent h-px " />
                    <div className="absolute inset-x-0 w-[70%] mx-auto z-30 -bottom-px bg-gradient-to-r from-transparent via-orange-600 to-transparent h-px " />
...
const testimonials = [
  {
    name: "John Doe",
    designation: "Préparateur physique",
    image:
      "https://images.unsplash.com/photo-1599566150163-29194dcaad36?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=3387&q=80",
  },
  {
    name: "Robert Johnson",
    designation: "Entraineur",
    image:
      "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8YXZhdGFyfGVufDB8fDB8fHww&auto=format&fit=crop&w=800&q=60",
  },
  {
    name: "Jane Smith",
    designation: "Réathletiseur",
    image:
  ...
  {
    name: "Dora",
    designation: "Responsable performance",
    image:
...
const testimonialsCarrousel = [
  {
    name: "John Doe",
    quote:
        "J'utilise formapulse au quotidien pour mes séance. J'adore créer mes propres exercices et utiliser les méthodologies intégrées à l'outil.",
    designation: "Préparateur physique",
    src:
      "https://images.unsplash.com/photo-1599566150163-29194dcaad36?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=3387&q=80",
  },
