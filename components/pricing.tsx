...
const plans: Array<Plan> = [
  ...
  },
  {
    ...
    buttonText: "Essai gratuit",
    additionalFeatures: ["Tout dans le plan Starter"],
    onClick: () => {
  ...
  },
  {
    ...
    additionalFeatures: ["Tout dans le plan Starter", "Tout dans le plan Premium"],
    ...
    >
      ...
      <>
        ...
        <p className="max-w-md mx-auto text-base text-center text-neutral-600 dark:text-neutral-300 mt-4">
          Commencez gratuitement à créer des séances pour vos sportifs.
        </p>
      </>
        ...
        >
          ...
          <div className="mt-8 ">
            <div className="flex items-end">
              <span
                className={cn(
                  "text-2xl font-bold text-neutral-500 dark:text-neutral-200"
                )}
              >
                {plan.currency}
              </span>
    ...
    <div className="flex items-start justify-start gap-2 my-4">
      <div
        className={cn(
          ...
          additional ? "bg-orange-600" : "bg-neutral-700"
        )}
      >
