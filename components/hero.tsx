...
import { productsHero } from "@/constants/data";
...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        {"Application de rencontre pour relations sérieuses et durables."}
      </motion.p>
      <motion.div
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      <motion.div
        ...
        ref={containerRef}
        className="relative mx-auto max-w-7xl rounded-md border border-neutral-200/50 bg-neutral-100 p-2 backdrop-blur-lg dark:border-[#f7cbe5]/10 dark:bg-[#f7cbe5]/10 md:p-4"
      >
        <div className="rounded-md border border-neutral-200 bg-white p-2 dark:border-[#f7cbe5]/40 dark:bg-[#f7cbe5]/40">
          {/* <Image
            src={"/hero_formapulse.png"}
            alt="header"
            width={1920}
            height={1080}
            className="rounded-md"
          /> */}
          <video width={1080} controls autoPlay muted loop className={"rounded-lg"}>
            <source src="https://storage.googleapis.com/mado-public/mado-video.mp4" type="video/mp4" />
            Your browser does not support the video tag.
          </video>
        </div>
      </motion.div>
      {/* <HeroParallax products={productsHero} id="view" /> */}
    </div>
  );
}
