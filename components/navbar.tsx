...
export const Navbar = () => {
  ...
  return (
    <motion.div ref={ref} className="w-full fixed top-0 inset-x-0 z-[120]">
        ...
        <AnimatePresence>
          {open && (
            ...
            >
              ...
              {/* <Button
                as={"button"}
                onClick={() => window.open("https://app.formafoot.fr", "_blank")}
                variant="primary"
              ...
              {/* <Button
                ...
                // data-cal-config={`{"layout":"${calOptions.layout}"}`}
                as="button"
                onClick={() => window.open("https://www.formafoot.fr/signup?saas=true", "_blank")}
                variant="secondary"
                className="block md:hidden w-full"
              >
                Créer un compte
